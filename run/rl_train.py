...
if args.reload_dir == "":
    ...
    env = Sym(env, dummy_env, sym_aug_new_eps=args.mea_eps if args.sym else 0, sym_action_noise=args.sym_action_noise, keep_sym_obs_key=['image','vector','fsm_state', "controller_state"])
