...
def save_frames_two_cams(camera0_name, camera1_name):
    ...
    while True:
        ...
        frame0 = frame0[:,160:1120]
        frame0= cv.resize(frame0, (800, 600))
        frame1 = frame1[:,160:1120]
        frame1= cv.resize(frame1, (800, 600))
...
if __name__ == '__main__':
    ...
    cmtx0, dist0 = calibrate_camera_for_intrinsic_parameters('/home/trs-learning/Downloads/csr_camera_calibration/l/*') 
    ...
    cmtx1, dist1 = calibrate_camera_for_intrinsic_parameters('/home/trs-learning/Downloads/csr_camera_calibration/r/*')
    ...
    R, T = stereo_calibrate(cmtx0, dist0, cmtx1, dist1, '/home/trs-learning/Downloads/csr_camera_calibration/l/*', 
                            '/home/trs-learning/Downloads/csr_camera_calibration/r/*')
    ...
    fs = cv.FileStorage("./cam_cal.yaml", cv.FILE_STORAGE_WRITE)
    fs.write("M1", cmtx0) 
    fs.write("D1", dist0) 
    fs.write("M2", cmtx1) 
    fs.write("D2", dist1)
    ...
    # # check_calibration('camera0', camera0_data, 'camera1', camera1_data, _zshift = 2.)
